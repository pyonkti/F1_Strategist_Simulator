...
"""
Drawing of the Weight Distribution of Overlapping and Being Overlapped
"""
...
plt.scatter(x, data)
plt.title("F1 Shanghai: Time cost of be overlapped from 2012 to 2018") 
plt.xlabel('milliseconds')
plt.ylabel('probability') 
plt.show()
"""
...
"""
Drawing of the curve fitted result
"""
