...
def getResult(raceId):
    ...
    fileName = str(".\GapPossibility\\"+raceDict[raceId]+"gapOvertakePossibility.eps")
    ...
    plt.ylabel('overtake possibility under the circumstance')
    fileName = str(".\LapTimeAdvPossibility\\"+raceDict[raceId]+"lapTimeAdvOvertakePossibility.eps")
    plt.savefig(fileName)
    plt.show()
    ...
    plt.ylabel('numbers')
    fileName = str(".\CostofOvertaking\\"+raceDict[raceId]+"CostofOvertaking.eps")
    plt.savefig(fileName)
    plt.show()
    ...
    plt.scatter(x, data) 
    plt.title("F1 Shanghai: Time cost Discrete Probability of Overtaking from 2012 to "+raceDict[raceId]) 
    plt.xlabel('milliseconds')
    plt.ylabel('probability')
    plt.show()
    
    plt.scatter(x, sumData) 
    plt.title("F1 Shanghai: Time cost Accumulated Probability of Overtaking from 2012 to "+raceDict[raceId]) 
    plt.xlabel('milliseconds')
    plt.ylabel('probability')
    plt.show()
    ...
    plt.xlabel('milliseconds')
    plt.ylabel('numbers')
    fileName = str(".\CostofBeingOvertook\\"+raceDict[raceId]+"CostofBeingOvertook.eps")
    plt.savefig(fileName)
    plt.show()
    ...
    plt.scatter(x, data) 
    plt.title("F1 Shanghai: Time cost Discrete Probability of being Overtook from 2012 to "+raceDict[raceId]) 
    plt.xlabel('milliseconds')
    plt.ylabel('probability')
    plt.show()
    
    plt.scatter(x, sumData) 
    plt.title("F1 Shanghai: Time cost Accumulated Probability of being Overtook from 2012 to "+raceDict[raceId]) 
    plt.xlabel('milliseconds')
    plt.ylabel('probability')
    plt.show()
